...
def skip_all_running_shifts(
    ...
    for skip_index in range(max_shift_skips):
        ...
        skip_shift_result = irrigation.skip_shift(
            running_program_id
        )
        ...
        if wait_until_program_not_running(
...
def stop_running_program(
    ...
    skip_program_result = irrigation.skip_program(
        running_program_id
    )
